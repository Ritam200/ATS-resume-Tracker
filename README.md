# ATS-resume-Tracker LLM Project: 

**ATS Resume Analyzer**, a cutting-edge application designed to mimic the expertise of an HR professional! This tool leverages the power of **Google Generative AI** to analyze resumes, evaluate job compatibility, and offer actionable insights for career enhancement.  

---

## 📋 **Project Overview**  

The **ATS Resume Analyzer** serves as a virtual HR assistant, providing:  
...
1. **Resume Parsing**  
   - Extracts text from PDF files using `pyPDF2` as a fallback.
